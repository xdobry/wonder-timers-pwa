  ...
  <div>
    ...
    <div id="app" class="md-layout md-gutter">
      <div class="md-layout-item">
        ...
        <md-button class="md-raised" v-on:click="addStopWatch" title="Add Stopwatch">
          Add
          <md-icon>watch</md-icon>
        </md-button>
        <md-button class="md-raised" v-on:click="addTimer" title="Add Timer">
          Add
      ...
      <div class="md-layout-item md-elevation-2">
        ...
        <md-table>
          ...
          <md-table-row v-for="(item,index) in timerMessages" v-bind:key="index">
            ...
            <md-table-cell>
              <md-button v-on:click="removeMessage(index)">
